...
2. เขียนไฟล์ Job script เพื่อส่งงานไปรันที่ Slurm (**ห้ามรีโมทไปรันที่เครื่อง compute node โดยตรง หรือรันงานที่เครื่อง login node**) ไฟล์ Job script ท่านสามารถระบุความต้องการต่าง ๆ ได้ เช่น ระบุจำนวนทรัพยากรที่ต้องการ (CPU, GPU, RAM) ระบุระยะเวลาที่ใช้ในการรัน ระบุ Partition ที่ต้องการใช้งาน เป็นต้น
3. ทำการ submit งานผ่าน Slurm batch หรือ interactive jobs จากเครื่อง login node 
