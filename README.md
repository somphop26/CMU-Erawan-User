...
-  #SBATCH -p [ชื่อพาร์ติชัน] <br/> กำหนดพาร์ติชันที่ต้องการใช้งาน โดยแต่ละพาร์ติชันมีทรัพยากร และระยะเวลาที่จำกัดแตกต่างกัน ผู้ใช้ควรดูว่างานของท่านใช้ทรัพยากร และระยะเวลาเท่าไหร่ที่เหมาะสมกับพาร์ติชันที่จะระบุ 

นอกจากนี้ มี option ที่ควรระบุ โดยได้อธิบายในตัวอย่างการรัน Slurm ในแบบต่าง ๆ แล้วดังนี้
