...
NODELIST จะแสดงสถานะของเครื่องที่กำลังทำงานอยู่ และบางกรณีจะแสดงสถานะอื่น เช่นเมื่อมีการกำหนดทรัพยากรเกินกว่าจำนวนที่มีจะขึ้น PartitionConflict หรือ อยู่ระหว่างรอทรัพยากรว่างจะขึ้น Priority
