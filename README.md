...
ควรกำหนดตัวแปร **--cpus-per-task=** และระบุตัวแปร **$SLURM_CPUS_PER_TASK** ในคำสั่งแทนการกำหนดเป็นตัวเลข การกำหนดเช่นนี้จะทำให้ Slurm รู้ว่างานของท่านใช้ CPU-core เท่าไหร่จะได้จัดสรรได้ถูกต้อง เพื่อจะได้ไม่มีปัญหาการรันงานเกินกว่าจำนวน CPU-core ที่มีในระบบซึ่งจะส่งผลต่อของประสิทธิภาพการใช้งาน
