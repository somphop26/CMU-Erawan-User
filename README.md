...
#### การรันงานแบบ Serial Jobs

งานที่เป็น Serial Job จะใช้ CPU 1 core ตัวแปรที่ใช้กำหนดคือ "--ntasks=1" ซึ่งจะกำหนดหรือไม่ก็ได้เพราะค่าเริ่มต้นของ --ntasks=1 อยู่แล้ว
...
#### การรันงานแบบ Multithreaded Jobs
