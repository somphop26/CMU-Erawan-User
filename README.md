...
NODELIST จะแสดงชื่อโหนดที่ทำงานในงานนั้น นอกจากนี้จะมีสถานะอื่น ๆ เช่น เมื่อมีการขอทรัพยากรเกินกว่าจำนวนที่มีอยู่จะขึ้นสถานะ PartitionConflict หรืออยู่ระหว่างรอทรัพยากรว่างเพียงพอต่องานที่รันจะขึ้นสถานะ Resources และอยู่ระหว่างรอคิวที่มีลำดับความสำคัญสูงกว่าจะขึ้นสถานะ Priority
