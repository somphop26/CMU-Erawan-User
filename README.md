...
- เมื่อมีการขอทรัพยากรเกินกว่าจำนวนที่มีอยู่จะขึ้นสถานะ PartitionConflict
- อยู่ระหว่างรอทรัพยากรว่างเพียงพอต่องานที่รันจะขึ้นสถานะ Resources
- อยู่ระหว่างรอคิวที่มีลำดับความสำคัญสูงกว่าจะขึ้นสถานะ Priority
...
งานที่เป็น Serial Job จะใช้ CPU 1 core ตัวแปรที่ใช้กำหนดคือ --ntasks= ซึ่งจะกำหนดหรือไม่ก็ได้เพราะค่าเริ่มต้นของ --ntasks=1 อยู่แล้ว
...
เมื่อ Submit ผ่าน Slurm จะต้องกำหนดที่ตัวแปร --ntasks=200 แทนการสั่งแบบเดิม
